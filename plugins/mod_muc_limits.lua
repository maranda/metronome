...
local gate_guard_hits = module:get_option_boolean("muc_gate_guard_max_hits", 150);
local gate_guard_time = module:get_option_boolean("muc_gate_guard_ban_time", 3600);
