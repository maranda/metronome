...
local add_descriptor = adhoc_new("Associate a client certificate with this account", add_xmlns, add_cert, "local_user");
local list_descriptor = adhoc_new("List associated client certificates with this account", list_xmlns, list_certs, "local_user");
